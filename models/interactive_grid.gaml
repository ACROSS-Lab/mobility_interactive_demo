...
global {
	...
	image_file image_file_test <- image_file("tmp.jpg");
	...
	list<point> distorsion_points <- [{481.1561279296875,2.0156326293945312,0.0},{1518.9725341796875,51.61836242675781,0.0},{1415.9482421875,1039.8260498046875,0.0},{458.2640686035156,971.1488647460938,0.0}];
	...
	init {
		//1 = white;  0 = black
		patterns << create_pattern("Empty building", 1,1,1,1);
	...
	action define_code {
		...
		write 'numbers of inhabitant: ' + length(inhabitant);
